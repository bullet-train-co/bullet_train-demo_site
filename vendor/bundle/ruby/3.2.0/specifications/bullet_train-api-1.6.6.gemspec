# -*- encoding: utf-8 -*-
# stub: bullet_train-api 1.6.6 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<pagy_cursor>.freeze, [">= 0"])
  s.add_runtime_dependency(%q<rack-cors>.freeze, [">= 0"])
  s.add_runtime_dependency(%q<doorkeeper>.freeze, [">= 0"])
  s.add_runtime_dependency(%q<jbuilder-schema>.freeze, [">= 2.4.0"])
  s.add_runtime_dependency(%q<factory_bot>.freeze, [">= 0"])
